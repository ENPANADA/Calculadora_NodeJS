...
app.post('/', function(req, res){
    ...
    res.send('<!DOCTYPE html><html lang="es"><head><meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0" /><title>Calculadora NodeJS</title></head><body style="height: 100vh; margin: 0; display: flex; flex-direction: row; align-items: center; justify-content: center; background-color: #1f1f1f;"><center><h3 style="color: rgb(29, 132, 216); margin: 0; font-size: 30px; font-weight: bold;">El resultado es: </h3><h2 style="color: azure; margin: 50px 0; font-size: 35px; font-weight: bold;">' + result + '</h2><a href="/"><button style="background-color: rgb(29, 132, 216); padding: 10px; margin: 0; font-weight: bold; color: azure; border: 5px solid azure; font-size: 15px; border-radius: 10px; cursor: pointer;">Volver</button></a></center></body></html>');
})
